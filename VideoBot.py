...
class LoadingWindow(QMainWindow):
    ...
    def start_checks(self):
        ...
        self.update_status(version_message, color="green", progress=25)
        ...
        if not pip_path:
            ...
            try:
                ...
                self.update_status("pip установлен ✅", color="green", progress=50)
            except Exception as e:
        ...
        try:
            ...
            self.update_status("Зависимости установлены ✅", color="green", progress=75)
        ...
        if not ffmpeg_path:
            ...
            try:
                ...
                self.update_status("FFmpeg установлен ✅", color="green", progress=100)
            except Exception as e:
    ...
    def install_python(self):
        ...
        try:
            ...
            self.update_status("Python 3.10 установлен ✅. Перезапустите программу.", color="green", progress=25)
